...
public class ProcessingEmployees {
	public static void main(String[] args) {
		...
		// Predicate that returns true for salaries in the range of $4000-$6000
		Predicate<Employee> fourToSixThousand = e -> (e.getSalary() >= 4000 && e.getSalary() <= 6000);

		// Display Employees with salaries in the range $4000-$6000 and sorted into ascending order by salary
		...
		System.out.printf("%nCount of Employees in each department:%n");
		...
		Comparator<Employee> empCompName = Comparator.comparing(getLastName);
				...
				.startsWith("B")).sorted(empCompName)
				.forEach(System.out::println);
